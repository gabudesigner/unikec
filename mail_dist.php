...
//insertamos código para pasar info con caracteres especiales UTF-8
	...
	$query = "INSERT INTO distribuidores (date, nombre, correo, mailadicional, contacto, provincia, ciudad, negocio, actividad, sitio, facebook, instagram, twitter, comentario) VALUES ('$n_date', '$n_name', '$email', '$scdmail', '$telefono', '$province', '$n_ciudad', '$empresa', '$descript', '$web', '$face', '$insta', '$twit', '$coment')";
