...
footer{background:#B80113; padding:25px 0; width:100%; color:aliceblue;font-size:14px;margin-top:60px;}
...
<br><br> <div class="bye">Aceptar</div> </div></div>

<header><div class="slider sl_cont"><!--SLIDERBACK-->
<div id="sld_t"> <img src="../uk_dat/img/logo2_wh.svg" id="lg" border="0"/> </div>
</div> </header>
...
<p style="font-size:14px;color:#900;font-style:italic;"> <strong>(*) Son campos obligatorios.</strong><br>
...
<form method="post" class="contacto" id="contacto" name="contacto">
<fieldset>  <div class="da">
...
<br>
	...
	<strong>(?)</strong> Ingresa a tu perfil de Facebook, Twitter o Instragram desde tu navegador preferido, copia el url de la barra de dirección de tu navegador y pegalo en el campo indicado.
	</span><br>
	...
	<button class="boton_envio" name="submit" type="submit">Registrarme</button> </div>
...
$(document).ready(function(){$(".bye").click(function(){$(".lautxt").remove();});
	...
	$(".boton_envio").click(function() {
		...
		$.ajax({  type: "POST",  url: "maildist.php",  data: datos,
	    		success: function() {
					$('.ajaxgif').hide();
